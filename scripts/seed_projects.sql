-- ═══════════════════════════════════════════════════════
-- 0. Create app_config table if it does not exist
-- ═══════════════════════════════════════════════════════
...
VALUES (
  ...
  'Cloudflare R2 CDN. Change this one row to switch CDN for every project image.',
  now()
...
-- ═══════════════════════════════════════════════════════
-- 2. Projects (one block per project)
-- ═══════════════════════════════════════════════════════

-- ── Next View 48 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Te
...
VALUES (
  (SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/next-view/next-view-fitag-tech-expo-it-show-gandhinagar-48-sqm-3-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Next View 48 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='next-view-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='3-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Acrrynics 18 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Te
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/acrrynics/acrrynics-fitag-tech-expo-it-show-gandhinagar-18-sqm-3-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Acrrynics 18 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='acrrynics-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='3-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Digisol 18 SQM 1 Side Open Stall Exhibition Stall Design at FITAG Tech
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/digisol/digisol-fitag-tech-expo-it-show-gandhinagar-18-sqm-1-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Digisol 18 SQM 1 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='digisol-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='1-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Lenovo Metrobit Networks 48 SQM 3 Side Open Stall Exhibition Stall Des
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/lenovo-metrobit-networks/lenovo-metrobit-networks-fitag-tech-expo-it-show-gandhinagar-48-sqm-3-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Lenovo Metrobit Networks 48 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='lenovo-metrobit-networks-48-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='3-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Securus 18 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/securus/securus-fitag-tech-expo-it-show-gandhinagar-18-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Securus 18 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='securus-18-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='2-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Voltaic Cable 24 SQM 3 Side Open Stall Exhibition Stall Design at FITA
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/voltaic-cable/voltaic-cable-fitag-tech-expo-it-show-gandhinagar-24-sqm-3-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Voltaic Cable 24 SQM 3 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='voltaic-cable-24-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='3-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;

-- ── Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Ex
INSERT INTO projects
  (title,slug,stall_area_sqm,stall_area_sqft,stall_height_m,floors,build_year,city,
   exhibition_id,client_id,description,design_brief,ai_summary,design_style,
   materials_used,special_features,awards,status,is_featured,display_order)
...
INSERT INTO seo_metadata
  (project_id,meta_title,meta_description,og_title,og_description,og_image_url)
VALUES (
  (SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),
...
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1) ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
...
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='security-devises' LIMIT 1),true) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='it' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='hardware' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM industries WHERE slug='television' LIMIT 1),false) ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary) VALUES ((SELECT id FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' LIMIT 1),(SELECT id FROM stall_types WHERE slug='2-side-open-stall' LIMIT 1),true) ON CONFLICT DO NOTHING;