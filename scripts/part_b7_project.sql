-- Run STEP 8: Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FIT
...
SELECT
  ...
  (SELECT id FROM clients WHERE slug='wian'),
...
SELECT id,'Wian 12 SQM Stall Design | FITAG Tech Expo - IT Show','Explore Wian''s 12 SQM 2 side open stall exhibition stall at FITAG Tech Expo - IT Show, Gandhinagar, designed and fabricated by Approach Media for impactful',
...
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
...
SELECT id,'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-02.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 1',1
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
SELECT id,'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-03.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 2',2
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
SELECT id,'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-04.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 3',3
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
SELECT id,'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-05.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 4',4
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
ON CONFLICT DO NOTHING;
INSERT INTO media (project_id,media_type,url,alt_text,display_order)
SELECT id,'image','2025/fitag-tech-expo-it-show/wian/wian-fitag-tech-expo-it-show-gandhinagar-12-sqm-2-side-open-stall-exhibition-stall-design-fabrication-approach-media-06.webp','Wian 12 SQM 2 Side Open Stall Exhibition Stall Design at FITAG Tech Expo - IT Show, Gandhinagar 2025 photo 5',5
FROM projects WHERE slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025'
ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary)
SELECT p.id,i.id,true
FROM projects p, industries i
WHERE p.slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' AND i.slug='security-devises'
ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary)
SELECT p.id,i.id,false
FROM projects p, industries i
WHERE p.slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' AND i.slug='it'
ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary)
SELECT p.id,i.id,false
FROM projects p, industries i
WHERE p.slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' AND i.slug='hardware'
ON CONFLICT DO NOTHING;
INSERT INTO project_industries (project_id,industry_id,is_primary)
SELECT p.id,i.id,false
FROM projects p, industries i
WHERE p.slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' AND i.slug='television'
ON CONFLICT DO NOTHING;
INSERT INTO project_stall_types (project_id,stall_type_id,is_primary)
SELECT p.id,s.id,true
FROM projects p, stall_types s
WHERE p.slug='wian-12-sqm-custom-exhibition-stall-fitag-tech-expo-it-show-gandhinagar-2025' AND s.slug='2-side-open-stall'
ON CONFLICT DO NOTHING;
