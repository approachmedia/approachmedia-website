  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'border-b border-border/20 bg-background/85 backdrop-blur-xl'
    ...
    >
      <div className="container-wide flex h-16 items-center justify-between gap-4 md:h-20">
        ...
        <button
          type="button"
          onClick={() => setOpen(o => !o)}
          className="rounded-md border border-border/20 p-2 text-foreground xl:hidden"
      ...
      {/* Mobile menu */}
      {open && (
        <div className="border-t border-border/20 bg-background/95 backdrop-blur-xl xl:hidden">
