...
export const kolkataData: CityPageData = {
  ...
  venueNotableShows: 'INDPLAS — Eastern India\'s largest international plastics exhibition (tri-annual, Indian Plastics Federation) · Kolkata Machine Tools Show — machine tools, engineering & factory automation (annual) · Medicall Kolkata — B2B medical equipment exhibition (annual)',
