...
export const suratData: CityPageData = {
  ...
  venueNotableShows: 'SITEX (Surat International Textile Expo), Surat International Auto Expo, Sparkle International Gems & Jewellery Exhibition, UDYOG Industrial Exhibition, Food & Beverage Expo, Wealth Expo, SGCCI Global Village, Textile Utsav, ROOTZ Jewellery Exhibition, WeaveKniTT, Women Entrepreneur Exhibition (WEE)',
