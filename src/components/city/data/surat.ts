...
export const suratData: CityPageData = {
  ...
  venueHeading: 'Exhibition stall contractor for SIECC, Sarsana & Surat trade venues',
  venueP1: 'Many major trade exhibitions in Surat are hosted at Surat International Exhibition and Convention Centre (SIECC), Sarsana — known for large-format exhibitions, B2B trade events and industry-focused shows across South Gujarat\'s business ecosystem.',
  venueP2: 'Stall execution depends on build-up schedules, material movement, electrical planning, organiser rules, height permissions, safety requirements and installation timelines. We plan each stall with these practical details in mind.',
  venueCtaLabel: 'Plan My Stall for SIECC',
  venueCardTitle: 'SIECC hosts',
  venueHosts: [
